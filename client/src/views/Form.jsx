...
// .form-input label {
//   position: absolute;
//   top: 0.75; /* Posisi label di bagian atas input */
//   left: 0;
//   right: 0;
//   font-size: 1rem;
//   color: #9CA3AF;
...
//   padding: 0 5rem;
//   background-color: transparent;
//   text-align: center center; /* Center the label text horizontally */
//   transform: translateY(1.5rem) scale(1);
// }
...
.form-input label {
  position: absolute;
  top: 50%; /* Posisi label di tengah vertikal dari input */
  left: 50%; /* Posisikan label di tengah secara horizontal dari container */
  transform: translateX(-50%) translateY(-50%) scale(1); /* Geser ke kiri dengan translateX dan sesuaikan Y dengan translateY */
  font-size: 1rem;
  color: #9CA3AF;
  transition: all 0.2s ease;
  pointer-events: none;
  transform-origin: center; /* Titik pusat transformasi di tengah */
  padding: 0 0.75rem; /* Padding kiri dan kanan */
  background-color: transparent;
  text-align: center; /* Tengah teks label secara horizontal */
}
...
.form-input input {
  ...
  border: none;
  border-bottom: 2px solid #CBD5E0;
  text-align: center; /* Tengah teks input */
  color: #000;
  outline: none;
}

.form-input input::placeholder {
  color: transparent; /* Sembunyikan placeholder default */
}

.form-input input:focus ~ label,
.form-input input:not(:placeholder-shown) ~ label {
  transform: translateX(-50%) translateY(-2rem) scale(0.75); /* Geser ke kiri dengan translateX dan sesuaikan Y dengan translateY */
  color: #7c3aed;
  font-size: 0.75rem;
}
