...
// // //             align-items: center;
// // //             height: 100vh;
// // //             padding-top: 3.5rem; /* Adjust for navbar height */
// // //           }
...
//       newErrors.origin = "Origin and Destination Field Must be different";
//     if (form.origin === form.destination)
//       newErrors.destination = "Origin and Destination Field Must be different";
//     if (!form.fullname) newErrors.fullname = "Full name is required";
//     if (!form.email) newErrors.email = "Email address is required";
//     if (!form.phoneNumber) newErrors.phoneNumber = "Phone number is required";
//     if (!form.origin) newErrors.origin = "Origin city is required";
...
// //           .form-input input:not(:placeholder-shown)::placeholder {
// //             color: #7c3aed;
// //             font-size: 0.875rem; /* Slightly smaller placeholder text on focus */
// //           }
...
// //             align-items: center;
// //             height: 100vh;
// //             padding-top: 4rem; /* Added padding to account for navbar */
