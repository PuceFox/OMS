...
import { ApolloError, useMutation } from "@apollo/client";
import { MUTATION_LOGIN } from "../queries";
import logo from "../assets/logo.png"; // Make sure you have the logo image in your assets folder
...
export default function Login() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-r from-purple-800 to-blue-500 py-6 flex flex-col justify-center sm:py-12">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-300 to-purple-800 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
          <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div className="max-w-md mx-auto">
