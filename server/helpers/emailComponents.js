function aircraftCard(serviceType, assetName, price, flightTime) {
  ...
  return `<div style="background-color: white; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); width: 300px; padding: 20px; text-align: center;">
              ...
              <button style="background-color: #007BFF; color: white; border: none; border-radius: 5px; padding: 10px 20px; font-size: 16px; cursor: pointer; margin-top: 20px;">
                  Choose
              </button>
          </div>`;
}
